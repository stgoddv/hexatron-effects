...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 406.0, 525.0, 261.0, 243.0 ],
					"varname" : "Harmonizer",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 354.5, 349.0, 174.0, 130.0 ],
					"varname" : "RMod",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 46.0, 660.0, 108.0, 73.0 ],
					"varname" : "Tremolo",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 42.0, 525.0, 132.0, 115.0 ],
					"varname" : "Reverb",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "VisualFilter.maxpat",
					"numinlets" : 3,
					"numoutlets" : 2,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 387.0, 33.0, 416.0, 179.0 ],
					"varname" : "VisualFilter",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 561.0, 317.0, 320.0, 162.0 ],
					"varname" : "Filter",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "DelayMultiBand.maxpat",
					"numinlets" : 3,
					"numoutlets" : 2,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 709.0, 525.0, 322.0, 153.0 ],
					"varname" : "DelayMultiBand",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 30.0, 33.0, 323.0, 152.0 ],
					"varname" : "Delay",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 30.0, 210.0, 281.0, 283.0 ],
					"varname" : "Comb",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 200.0, 525.0, 165.0, 109.0 ],
					"varname" : "Chorus",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 364.0, 262.0, 46.0, 57.0 ],
					"varname" : "Balance",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-7::obj-27" : [ "DelTimeLDelay[1]", "DelL", 0 ],
			...
			"obj-7::obj-109" : [ "MiddleDelLDelay[1]", "MidDelL", 0 ],
			...
			"obj-10::obj-13" : [ "BypassVisualFilter", "On Filtro Visual", 0 ],
			...
			"obj-7::obj-32" : [ "LowEnableDelay[1]", "LowEnable", 0 ],
			...
			"obj-7::obj-111" : [ "HighDelRDelay[1]", "HiDelR", 0 ],
			"obj-10::obj-11" : [ "FiltroVisual", "FiltroVisual", 0 ],
			...
			"obj-7::obj-4" : [ "LowGainDelay[1]", "Low", 0 ],
			...
			"obj-7::obj-45" : [ "DryWetDelay[1]", "D/Wet", 0 ],
			...
			"obj-10::obj-114" : [ "live.text[2]", "live.text", 0 ],
			...
			"obj-7::obj-24" : [ "DelTimeRDelay[1]", "DelR", 0 ],
			...
			"obj-7::obj-14" : [ "HighFreqDelay[1]", "HiXFreq", 0 ],
			"obj-10::obj-22" : [ "DryWetVisualFilter", "D/Wet", 0 ],
			"obj-13::obj-1::obj-21::obj-5::obj-109" : [ "MiddleDelLDelay[2]", "MidDelL", 0 ],
			"obj-1::obj-18" : [ "PanLevel", "PanLevel", 0 ],
			"obj-6::obj-8" : [ "HighGainDelay", "High", 0 ],
			"obj-7::obj-108" : [ "MiddleDelRDelay[1]", "MidDelR", 0 ],
			"obj-14::obj-50" : [ "Level3Harm", "Level", 0 ],
			"obj-5::obj-64" : [ "InputComb", "Input", 1 ],
			"obj-7::obj-43" : [ "HighEnableDelay[1]", "HighEnable", 0 ],
			"obj-6::obj-17" : [ "LowFreqDelay", "LoXFreq", 0 ],
			"obj-7::obj-8" : [ "HighGainDelay[1]", "High", 0 ],
			...
			"obj-7::obj-22" : [ "LowDelLDelay[1]", "LoDelL", 0 ],
...
,
			"parameter_overrides" : 			{
				"obj-7::obj-27" : 				{
					"parameter_longname" : "DelTimeLDelay[1]"
				}
,
				"obj-7::obj-20" : 				{
					"parameter_longname" : "FbDelay[1]"
				}
,
...
,
				"obj-7::obj-17" : 				{
					"parameter_longname" : "LowFreqDelay[1]"
				}
,
				"obj-7::obj-6" : 				{
					"parameter_longname" : "MiddleGainDelay[1]"
				}
,
				"obj-7::obj-112" : 				{
					"parameter_longname" : "HighDelLDelay[1]"
				}
,
...
,
				"obj-7::obj-109" : 				{
					"parameter_longname" : "MiddleDelLDelay[1]"
				}
,
...
,
				"obj-7::obj-15" : 				{
					"parameter_longname" : "LowFbDelay[1]"
				}
,
				"obj-7::obj-38" : 				{
					"parameter_longname" : "MiddleEnableDelay[1]"
				}
,
...
,
				"obj-7::obj-5" : 				{
					"parameter_longname" : "MiddleFbDelay[1]"
				}
,
				"obj-7::obj-39" : 				{
					"parameter_longname" : "OnDelay[1]"
				}
,
				"obj-7::obj-11" : 				{
					"parameter_longname" : "LowDelRDelay[1]"
				}
,
...
,
				"obj-7::obj-32" : 				{
					"parameter_longname" : "LowEnableDelay[1]"
				}
,
				"obj-7::obj-111" : 				{
					"parameter_longname" : "HighDelRDelay[1]"
				}
,
...
,
				"obj-7::obj-4" : 				{
					"parameter_longname" : "LowGainDelay[1]"
				}
,
...
,
				"obj-7::obj-35" : 				{
					"parameter_longname" : "ModeDelay[1]"
				}
,
				"obj-7::obj-13" : 				{
					"parameter_longname" : "HighFbDelay[1]"
				}
,
				"obj-7::obj-45" : 				{
					"parameter_longname" : "DryWetDelay[1]"
				}
,
...
,
				"obj-7::obj-24" : 				{
					"parameter_longname" : "DelTimeRDelay[1]"
				}
,
				"obj-7::obj-14" : 				{
					"parameter_longname" : "HighFreqDelay[1]"
				}
,
...
,
				"obj-7::obj-108" : 				{
					"parameter_longname" : "MiddleDelRDelay[1]"
				}
,
				"obj-7::obj-43" : 				{
					"parameter_longname" : "HighEnableDelay[1]"
				}
,
				"obj-7::obj-8" : 				{
					"parameter_longname" : "HighGainDelay[1]"
				}
,
...
,
				"obj-7::obj-22" : 				{
					"parameter_longname" : "LowDelLDelay[1]"
				}
,
